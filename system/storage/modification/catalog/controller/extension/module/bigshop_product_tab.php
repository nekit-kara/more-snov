...
$data['module'] = $setting;
		...
		$data['products'] = array();
			...
			$data['bigshop_product_tab_slider_product_style'] = $this->config->get('bigshop_product_tab_slider_product_style');
			$data['bigshop_percentage_discount_badge'] = $this->config->get('bigshop_percentage_discount_badge');
			$data['bigshop_product_tab_slider_product_per_row'] = $this->config->get('bigshop_product_tab_slider_product_per_row');
		...
		return $this->load->view('extension/module/bigshop_product_tab', $data);
