...
class ControllerProductCompare extends Controller
{
    ...
    public function index()
    {
        ...
        if (isset($this->request->get['remove'])) {
            ...
            $this->response->redirect($this->url->link('product/compare', '', $this->ssl));
        }
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('product/compare', '', $this->ssl)
        );
        ...
        foreach ($this->session->data['compare'] as $key => $product_id) {
            ...
            if ($product_info) {
                ...
                //begin_devos_attribute_ext
                $attribute_groups = $this->model_catalog_devos_attribute_ext->daeCompare($product_id, array('attributes' => $attribute_groups));
                //end_devos_attribute_ext
                ...
                $data['products'][$product_id] = array(
                    ...
                    'href' => $this->url->link('product/product', 'product_id=' . $product_id, $this->ssl),
                    'remove' => $this->url->link('product/compare', 'remove=' . $product_id, $this->ssl)
                );
    ...
    public function add()
    {
        ...
        if ($product_info) {
            ...
            $json['success'] = sprintf($this->language->get('text_success'), $this->url->link('product/product', 'product_id=' . $this->request->post['product_id'], $this->ssl), $product_info['name'], $this->url->link('product/compare', '', $this->ssl));
