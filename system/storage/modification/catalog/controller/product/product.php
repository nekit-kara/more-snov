...
class ControllerProductProduct extends Controller
{
    ...
    public function index()
    {
        ...
        if (isset($this->request->get['path'])) {
            ...
            foreach ($parts as $path_id) {
                ...
                if ($category_info) {
                    $data['breadcrumbs'][] = array(
                        ...
                        'href' => $this->url->link('product/category', 'path=' . $path, $this->ssl)
                    );
                }
            }
            ...
            if ($category_info) {
                ...
                $data['breadcrumbs'][] = array(
                    'text' => $category_info['name'],
                    'href' => $this->url->link('product/category', 'path=' . $this->request->get['path'] . $url, $this->ssl)
                );
            }
        }
        ...
        if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
            ...
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('product/search', $url, $this->ssl)
            );
        }
        ...
        if ($product_info) {
            ...
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('product/product', $url . '&product_id=' . $this->request->get['product_id'], $this->ssl)
            );

            $this->document->setTitle($product_info['meta_title']);
            $this->document->setDescription($product_info['meta_description']);
            $this->document->setKeywords($product_info['meta_keyword']);
            $this->document->addLink($this->url->link('product/product', 'product_id=' . $this->request->get['product_id'], $this->ssl), 'canonical');
            ...
            $data['text_login'] = sprintf($this->language->get('text_login'), $this->url->link('account/login', '', $this->ssl), $this->url->link('account/register', '', $this->ssl));
            ...
            $data['manufacturers'] = $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $product_info['manufacturer_id'], $this->ssl);
            ...
            $data['share'] = $this->url->link('product/product', 'product_id=' . (int)$this->request->get['product_id'], $this->ssl);
            ...
            $data['dae_attribute_view'] = $this->model_catalog_devos_attribute_ext->daeProduct($this->request->get['product_id']);
            $data['attribute_groups'] = $this->model_catalog_devos_attribute_ext->daeProductTab($this->request->get['product_id'], array('attributes' => $data['attribute_groups']));
            ...
            if ($product_info['tag']) {
                ...
                foreach ($tags as $tag) {
                    $data['tags'][] = array(
                        'tag' => trim($tag),
                        'href' => $this->url->link('product/search', 'tag=' . trim($tag), $this->ssl)
                    );
                }
            }
            ...
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('product/product', $url . '&product_id=' . $product_id, $this->ssl)
            );
    ...
    public function review()
    {
        ...
        $pagination->limit = 5;
        $pagination->url = $this->url->link('product/product/review', 'product_id=' . $this->request->get['product_id'] . '&page={page}', $this->ssl);
