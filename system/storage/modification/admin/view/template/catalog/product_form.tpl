      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
			...
			<label class="col-sm-2 control-label" for="input-description<?php echo $language['language_id']; ?>"><?php echo 'H1' ?></label>
                    <div class="col-sm-10" style="margin-bottom: 15px">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][meta_h1]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_h1'] : ''; ?>" placeholder="<?php echo 'Custom H1'; ?>" id="input-meta-title<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
            ...
            <div class="tab-pane" id="tab-data">
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-duvet_cover"><?php echo $entry_duvet_cover; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="duvet_cover" value="<?php echo $duvet_cover; ?>" placeholder="<?php echo $entry_duvet_cover; ?>" id="input-duvet_cover" class="form-control" />
                </div>
              </div>
              <div class="form-group">
...
$('input[name=\'category\']').autocomplete({
	...
	'select': function(item) {
	  ...
	  daeAutoLoadAttributeFromCategory(item['value']);
...
$(window).ready(function(){
  $.ajax({
    url: 'index.php?route=catalog/devos_attribute_ext/getTabAttributeProduct&token=<?php echo $token; ?>&product_id=<?php echo $dae_product_id;?>',
    type: "GET",
    dataType: 'html',
