...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		$data['entry_duvet_cover'] = $this->language->get('entry_duvet_cover');
	...
	protected function getForm() {
		...
		if (isset($this->request->post['duvet_cover'])) {
			$data['duvet_cover'] = $this->request->post['duvet_cover'];
		} elseif (!empty($product_info)) {
			$data['duvet_cover'] = $product_info['duvet_cover'];
		} else {
			$data['duvet_cover'] = '';
		}
	  ...
	  $data['dae_product_id'] =  (isset($this->request->get['product_id']))?$this->request->get['product_id']:0;
