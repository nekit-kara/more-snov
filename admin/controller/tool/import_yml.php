...
class ControllerToolImportYml extends Controller { 
  ...
  public function index() 
  {
    ...
    $data['save'] = $this->url->link('tool/import_yml/save', 'token=' . $this->session->data['token'], true);
    ...
    $data['action'] = $this->url->link('tool/import_yml', 'token=' . $this->session->data['token'], true);

    $data['export'] = $this->url->link('tool/import_yml/download', 'token=' . $this->session->data['token'], true);
    ...
    if (!empty($this->settings['import_yml_url'])) {
      ...
      if ($data['loaded']) {
        $this->session->data['success'] = sprintf(
          ...
          $this->url->link('tool/import_yml/cancel', 'token=' . $this->session->data['token'], true)
        );
