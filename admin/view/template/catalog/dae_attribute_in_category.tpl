  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $dae_attr_in_cat_header; ?></h3>
      </div>
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
          <div class="row">
            <div class="col-md-6"> 
                <div class="row">
                  <div class="col-xs-12">
                    <label class="control-label"><span data-toggle="tooltip" title="" data-original-title="<?php echo $dae_a_in_c_category_help;?>"><?php echo $dae_a_in_c_category;?></span></label>                    
                  </div>
                  <div class="col-xs-12">          
                ...
                <div class="row">
                  <div class="col-xs-12">
                    <label class="control-label"><span data-toggle="tooltip" title="" data-original-title="<?php echo $dae_a_in_c_category_more_help;?>"><?php echo $dae_a_in_c_category_more;?></span></label>                    
                  </div>
                  <div class="col-xs-12">          
                    <input type="text" name="categories_name" id="categories_name"  value="" placeholder="" class="form-control" autocomplete="off">
                    <div id="dae_box_category" class="well well-sm" style="height: 337px; overflow: auto;margin-bottom: 0px;">                 
                      </div>
                  </div>
                </div>
            </div>
            <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-xs-12">
                  <label class="control-label"><span data-toggle="tooltip" title="" data-original-title="<?php echo $dae_a_in_c_attribute_list_help;?>"><?php echo $dae_a_in_c_attribute_list;?></span></label>                    
                </div>
                <div class="col-xs-12">          
  ...
  */
  $('#category_name').autocomplete({
      ...
      'select': function(item) {
        ...
        //загрузка привязанных атрибутов
        $.ajax({
          url: 'index.php?route=catalog/devos_attribute_ext/loadAttributeFromCategory&token=<?php echo $token; ?>',
