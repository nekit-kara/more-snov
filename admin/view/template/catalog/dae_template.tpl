      ...
      <div class="panel-body">
          <div class="row">
            <div class="col-sm-4">
              ...
              <?php foreach($dae_templates as $dae_template){?>
            ...
            <div class="col-sm-8"> 
              <div class="tab-content dae-attribute-list-for-group">
                ...
                <div id="tab-dae-attribute<?php echo $attribute_group['attribute_group_id'];?>" class="tab-pane fade">
                  ...
                  <div class="btn-group">
                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $dae_lang_auto_load;?> <span class="caret"></span></button>
                  ...
                  <a href="<?php echo $url_a_merge;?>" class="btn btn-default"><?php echo $dae_lang_a_merge;?></a>
                  <a href="<?php echo $url_a_to_cat;?>" class="btn btn-default"><?php echo $dae_attr_in_cat_header;?></a>                  
                  <a href="<?php echo $url_setup;?>" class="btn btn-default"><i class="fa fa-cog"></i> <?php echo $dae_lang_setup;?></a>
                    ...
                    <table class="table table-hover">
                      <thead>
                        <tr>
                          ...
                          <td class="text-right"><?php echo $dae_column_action; ?></td>
                        </tr>
                      </thead>
                      <tbody class="dae_attribute_sorted">
                        ...
                        <tr id="dae_attribute_<?php echo $attribute['attribute_id'];?>" >
                          ...
                          <td class="text-right">
                            <button type="button" data-toggle="tooltip" title="<?php echo $dae_lang_button_list_attr; ?>" class="btn btn-primary" onclick="daeViewFormValue(<?php echo $attribute['attribute_id'];?>);"><i class="fa fa-list"></i></button>
