...
class ControllerExtensionModuleCategoryAccordion extends Controller
{
    ...
    protected function loadCategories($parent_id, $current_path = '', $cid = '')
    {
        ...
        foreach ($results as $result) {
            ...
            if ($children) {
                $ret_string .= '<a class="' . $classactive . '" href="' . $this->url->link('product/category', 'path=' . $new_path, $this->ssl) . '">' . $result['name'] . '</a> <span class="down"></span>';
            } else {
                $ret_string .= '<a class="' . $classactive . '" href="' . $this->url->link('product/category', 'path=' . $new_path, $this->ssl) . '">' . $result['name'] . '</a>';
            }
