<?php echo $header; ?>
<div class="container-fluid b-item-page">
  <div class="container">
  <ul class="breadcrumb">
  ...
  <div class="row product-info"><?php echo $column_left; ?>
          ...
          <div class="<?php echo $class; ?>">
            <div class="product-detail" id="product">
              <div class="b-product-params">
                  ...
                  <?php } ?>
                  <div class="b-product-params__item"><?php echo $text_stock; ?> <?php echo $stock; ?></div>
                  <!--<div class="b-product-params__item">Цвет:</div>-->
              </div>
				<div class="b-all-params">
					<a href="#">Все характеристики</a>
				</div>
              <div class="b-product-size">
                <?php if ($options) { ?>
                <?php foreach ($options as $option) { ?>
                <?php if ($option['type'] == 'select') { ?>
                <select name="option[<?php echo $option['product_option_id']; ?>]" id="input-option<?php echo $option['product_option_id']; ?>" class="b-product-size__select">
                    <?php foreach ($option['product_option_value'] as $key => $option_value) { ?>
                      <? if($key==0) { ?>
                        <option class="b-product-size__option" value="<?php echo $option_value['product_option_value_id']; ?>" selected="true"><?php echo $option_value['name']; ?>
                        </option>
                      <? } else { ?>
              ...
              <div class="b-product-buy">
                <?php if ($price) { ?>
                  <div class="b-product-price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                    <?php if (!$special) { ?>
                      <div class="b-product-price__new" itemprop="price"><?php echo $price; ?></div>
                      <div style="display: none"><span itemprop="availability" content="<?php echo $stock; ?>"></span></div>
                    <?php } else { ?>
                      <div class="b-product-price__old"><?php echo $price; ?></div>
                      <div class="b-product-price__new" itemprop="price"><?php echo $special; ?></div>
                      <div style="display: none"><span itemprop="availability" content="<?php echo $stock; ?>"></span></div>
                    <?php } ?>
                  </div>
                  <div class="b-buy-button">
                    <div class="cart">
                      <div>
                        ...
                        <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="b-buy-button__link"><?php echo $button_cart; ?></button>
                      </div>
                    </div>
                  </div>
                  <div class="clear"></div>            
  ...
  $.ajax({
    ...
    success: function(json) {
      ...
      if (json['success']) {
        ...
        $('#cart > button').html('<div class="b-user-menu__link"><i class="icon icon_cart"></i><span id="cart-total"> ' + json['total'] + '</span></div>');
